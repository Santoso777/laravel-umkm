...
<head>
  <meta charset="utf-8">
  <title>Maswira Jogja-maswira</title>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero">
          <img src="{{asset('user/images/icon.jpg')}}" style="margin-right:5px"/></img>
          <h2 class="d-inline text-light">Maswira Jogja</h2>
        </a>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="{{$url=='blog'?'menu-active':''}}"><a href="{{url('blog')}}">Product</a></li>
